...
impl Backend {
    ...
    pub fn render(
        ...
        if display_points {
            ...
            match mode {
                ...
                _ => {
                    ...
                    //             },
                    //         };
                    //         Circle::new((candle.date, price), 0, style).into_dyn()
                    //     } else {
                    //         Circle::new(
                    //             (candle.date, price),
                    //             0,
        ...
        //                 TriangleMarker::new((date, order.target_price), 6, &BLUE_LINE2.mix(2.))
        //             }
